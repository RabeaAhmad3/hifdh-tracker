-- ============================================================
-- 00011: Notification Preferences
-- Per-user, per-type push notification opt-out toggles.
-- Filtering happens in send_push_notification() so trigger
-- functions remain untouched.
-- ============================================================

-- 1. Preferences table (lazy creation — no row = all enabled)
CREATE TABLE notification_preferences (
  user_id       UUID PRIMARY KEY REFERENCES profiles(id) ON DELETE CASCADE,
  new_assignment BOOLEAN NOT NULL DEFAULT TRUE,
  new_message    BOOLEAN NOT NULL DEFAULT TRUE,
  meeting_booked BOOLEAN NOT NULL DEFAULT TRUE,
...
-- 2. Replace send_push_notification() with preference-aware version
